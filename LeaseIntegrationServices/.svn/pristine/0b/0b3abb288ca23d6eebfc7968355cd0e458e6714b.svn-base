...
public class MailServices {
    ...
    public static String mailNotificationWithAttachment(String username, String password,  byte[] bytes,
            String toAddress, String ccAddress, String subject, Object mailContent, String fileName) {
